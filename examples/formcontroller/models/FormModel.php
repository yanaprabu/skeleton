...
class FormModel extends A_Model_Form {
	function __construct($locator=null) {
		...
		$this->addField($field1 = new A_Model_Form_Field('field1'));
		...
		$this->addField($field2 = new A_Model_Form_Field('field2'));
		...
		$this->addField($field3 = new A_Model_Form_Field('field3'));
		...
		$this->addField($field4 = new A_Model_Form_Field('field4'));
		...
		$this->addRule(new A_Rule_Match('field3', 'field4', 'field 3 must match field 4'));
