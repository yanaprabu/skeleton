...
$template = new A_Template_Strreplace('template/layout.html');
...
$template1 = new A_Template_Strreplace('template/block1.html');
...
$template2 = new A_Template_Strreplace('template/block2.html');
