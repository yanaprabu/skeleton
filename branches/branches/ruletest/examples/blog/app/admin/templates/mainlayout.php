...
<head>
	<title><?php echo "Blog Admin: $title"; ?></title>
...
<div id="container">
	...
	<div id="header">
		<h1><?php echo "Blog Admin: $title"; ?></h1>
		...
		<div id="loginbox">
			<p>User: <a href="<?php echo $BASE ?>user/login/">login</a> | <a href="<?php echo $BASE ?>user/logout">logout</a></p>
		</div>
	</div>
